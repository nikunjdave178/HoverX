...
# Dark-fill variants for use on the light circular play/pause button, where a
# white icon would be invisible.
PLAY_SVG_DARK = PLAY_SVG.replace('fill="white"', 'fill="#181818"')
PAUSE_SVG_DARK = PAUSE_SVG.replace('fill="white"', 'fill="#181818"')
